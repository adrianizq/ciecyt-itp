...
@Component
export default class PresupuestoValor extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllPresupuestoValors();
  }
  ...
  public retrieveAllPresupuestoValors(): void {
  ...
  public prepareRemove(instance: IPresupuestoValor): void {
    this.removeId = instance.id;
  }

  public removePresupuestoValor(): void {
    this.presupuestoValorService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('ciecytApp.presupuestoValor.deleted', { param: this.removeId });
