...
export default class CronogramaCiecytFases extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllCronogramaCiecytFasess();
  }
  ...
  public retrieveAllCronogramaCiecytFasess(): void {
    ...
    this.cronogramaCiecytFasesService()
      ...
      .then(
        res => {
          this.cronogramaCiecytFases = res.data;
  ...
  public prepareRemove(instance: ICronogramaCiecytFases): void {
    this.removeId = instance.id;
  }

  public removeCronogramaCiecytFases(): void {
    this.cronogramaCiecytFasesService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('ciecytApp.cronogramaCiecytFases.deleted', { param: this.removeId });
