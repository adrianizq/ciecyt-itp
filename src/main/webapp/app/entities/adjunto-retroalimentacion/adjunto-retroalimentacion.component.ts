...
@Component
export default class AdjuntoRetroalimentacion extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllAdjuntoRetroalimentacions();
  }
  ...
  public retrieveAllAdjuntoRetroalimentacions(): void {
  ...
  public prepareRemove(instance: IAdjuntoRetroalimentacion): void {
    this.removeId = instance.id;
  }

  public removeAdjuntoRetroalimentacion(): void {
    this.adjuntoRetroalimentacionService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('ciecytApp.adjuntoRetroalimentacion.deleted', { param: this.removeId });
