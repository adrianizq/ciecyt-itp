...
@Component
export default class RolesModalidad extends mixins(Vue2Filters.mixin) {
  ...
  public mounted(): void {
    this.retrieveAllRolesModalidads();
  }
  ...
  public retrieveAllRolesModalidads(): void {
  ...
  public prepareRemove(instance: IRolesModalidad): void {
    this.removeId = instance.id;
  }

  public removeRolesModalidad(): void {
    this.rolesModalidadService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('ciecytApp.rolesModalidad.deleted', { param: this.removeId });
