                 ...
                 <div class="col-12">
                    <b-card  
                     ...
                     header-text-variant="info">  
                      ...
                      <table> 
                      <tr><td><h2>Sustentación del Proyecto </h2></td></tr>
                ...
                <div class="col-12">
                  ...
                  <hr></hr>
                    ...
                    <b-card  
                     ...
                     header-text-variant="info">
                    <b-form-group 
                    description="Si tiene comentarios o sugerencias adicionales sobre la sustentación del proyecto, diligencie este apartado">
