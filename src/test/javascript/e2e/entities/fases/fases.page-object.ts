...
export default class FasesComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('fases-heading'));
...
export class FasesDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.fases.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fases'));
}
