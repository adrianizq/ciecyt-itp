...
export default class ProyectoComponentsPage extends AlertPage {
...
export class ProyectoDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.proyecto.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-proyecto'));
}
