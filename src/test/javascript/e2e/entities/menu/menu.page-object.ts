...
export default class MenuComponentsPage extends AlertPage {
...
export class MenuDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.menu.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-menu'));
}
