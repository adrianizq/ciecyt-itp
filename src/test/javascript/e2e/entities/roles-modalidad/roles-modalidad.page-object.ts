...
export default class RolesModalidadComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('roles-modalidad-heading'));
...
export class RolesModalidadDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.rolesModalidad.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-rolesModalidad'));
}
