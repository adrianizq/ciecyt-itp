...
export default class RubroComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('rubro-heading'));
...
export class RubroDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.rubro.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-rubro'));
}
