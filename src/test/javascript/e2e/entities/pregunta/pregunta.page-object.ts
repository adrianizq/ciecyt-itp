...
export default class PreguntaComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('pregunta-heading'));
...
export class PreguntaDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.pregunta.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-pregunta'));
}
