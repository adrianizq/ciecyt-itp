...
export default class ImpactosEsperadosComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('impactos-esperados-heading'));
...
export class ImpactosEsperadosDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.impactosEsperados.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-impactosEsperados'));
}
