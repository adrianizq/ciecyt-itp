...
export default class FacultadComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('facultad-heading'));
...
export class FacultadDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.facultad.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-facultad'));
}
