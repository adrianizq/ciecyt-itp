...
export default class FichaTecnicaComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ficha-tecnica-heading'));
...
export class FichaTecnicaDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.fichaTecnica.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-fichaTecnica'));
}
