...
export default class ProyectoRespuestasComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('proyecto-respuestas-heading'));
...
export class ProyectoRespuestasDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.proyectoRespuestas.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-proyectoRespuestas'));
}
