...
export default class CronogramaCiecytComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('cronograma-ciecyt-heading'));
...
export class CronogramaCiecytDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.cronogramaCiecyt.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cronogramaCiecyt'));
}
