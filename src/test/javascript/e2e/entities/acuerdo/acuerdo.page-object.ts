...
export default class AcuerdoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('acuerdo-heading'));
...
export class AcuerdoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.acuerdo.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-acuerdo'));
}
