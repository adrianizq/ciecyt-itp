...
export default class IntegranteProyectoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('integrante-proyecto-heading'));
...
export class IntegranteProyectoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.integranteProyecto.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-integranteProyecto'));
}
