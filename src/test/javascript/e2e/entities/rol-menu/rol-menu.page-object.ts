...
export default class RolMenuComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('rol-menu-heading'));
...
export class RolMenuDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.rolMenu.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-rolMenu'));
}
