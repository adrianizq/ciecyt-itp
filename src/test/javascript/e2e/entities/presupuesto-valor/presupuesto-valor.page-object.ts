...
export default class PresupuestoValorComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('presupuesto-valor-heading'));
...
export class PresupuestoValorDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.presupuestoValor.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-presupuestoValor'));
}
