...
export default class ProductoComponentsPage extends AlertPage {
...
export class ProductoDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.producto.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-producto'));
}
