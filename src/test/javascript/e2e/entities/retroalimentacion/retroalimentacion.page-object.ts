...
export default class RetroalimentacionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('retroalimentacion-heading'));
...
export class RetroalimentacionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.retroalimentacion.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-retroalimentacion'));
}
