...
export default class TipoPreguntaComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('tipo-pregunta-heading'));
...
export class TipoPreguntaDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.tipoPregunta.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-tipoPregunta'));
}
