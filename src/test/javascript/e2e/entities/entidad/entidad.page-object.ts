...
export default class EntidadComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('entidad-heading'));
...
export class EntidadDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.entidad.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-entidad'));
}
