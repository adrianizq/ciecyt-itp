...
export default class ModalidadComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('modalidad-heading'));
...
export class ModalidadDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.modalidad.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-modalidad'));
}
