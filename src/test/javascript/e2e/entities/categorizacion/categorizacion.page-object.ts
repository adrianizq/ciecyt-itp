...
export default class CategorizacionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('categorizacion-heading'));
...
export class CategorizacionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.categorizacion.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-categorizacion'));
}
