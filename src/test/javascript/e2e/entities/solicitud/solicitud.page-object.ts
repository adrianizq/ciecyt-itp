...
export default class SolicitudComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('solicitud-heading'));
...
export class SolicitudDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.solicitud.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-solicitud'));
}
