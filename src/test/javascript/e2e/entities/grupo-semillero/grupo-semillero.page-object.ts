...
export default class GrupoSemilleroComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('grupo-semillero-heading'));
...
export class GrupoSemilleroDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.grupoSemillero.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-grupoSemillero'));
}
