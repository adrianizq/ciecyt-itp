...
export default class FormatoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('formato-heading'));
...
export class FormatoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.formato.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-formato'));
}
