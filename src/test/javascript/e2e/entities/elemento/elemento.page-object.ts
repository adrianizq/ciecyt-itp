...
export default class ElementoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('elemento-heading'));
...
export class ElementoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.elemento.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-elemento'));
}
