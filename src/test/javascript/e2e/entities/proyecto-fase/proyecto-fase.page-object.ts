...
export default class ProyectoFaseComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('proyecto-fase-heading'));
...
export class ProyectoFaseDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.proyectoFase.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-proyectoFase'));
}
