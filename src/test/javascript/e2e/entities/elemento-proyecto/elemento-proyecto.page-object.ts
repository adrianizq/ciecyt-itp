...
export default class ElementoProyectoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('elemento-proyecto-heading'));
...
export class ElementoProyectoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.elementoProyecto.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-elementoProyecto'));
}
