...
export default class ProductoProyectoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('producto-proyecto-heading'));
...
export class ProductoProyectoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.productoProyecto.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-productoProyecto'));
}
