...
export default class UsuarioComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('usuario-heading'));
...
export class UsuarioDeleteDialog {
  ...
  title: ElementFinder = element(by.id('ciecytApp.usuario.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-usuario'));
}
