...
export default class CicloPropedeuticoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('ciclo-propedeutico-heading'));
...
export class CicloPropedeuticoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.cicloPropedeutico.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-cicloPropedeutico'));
}
