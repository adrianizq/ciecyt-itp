...
export default class LineaInvestigacionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('linea-investigacion-heading'));
...
export class LineaInvestigacionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('ciecytApp.lineaInvestigacion.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-lineaInvestigacion'));
}
