...
import ElementoProyectoComponent from '@/entities/elemento-proyecto/elemento-proyecto.vue';
import ElementoProyectoClass from '@/entities/elemento-proyecto/elemento-proyecto.component';
...
describe('Component Tests', () => {
  describe('ElementoProyecto Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ElementoProyectoClass>(ElementoProyectoComponent, {
        store,
        i18n,
        localVue,
    ...
    it('Should call load all on init', async () => {
      ...
      // WHEN
      comp.retrieveAllElementoProyectos();
      await comp.$nextTick();

      // THEN
      expect(elementoProyectoServiceStub.retrieve.called).toBeTruthy();
      expect(comp.elementoProyectos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(elementoProyectoServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(elementoProyectoServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
