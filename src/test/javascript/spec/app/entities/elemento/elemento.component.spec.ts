...
import ElementoComponent from '@/entities/elemento/elemento.vue';
import ElementoClass from '@/entities/elemento/elemento.component';
...
describe('Component Tests', () => {
  describe('Elemento Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ElementoClass>(ElementoComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(elementoServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(elementoServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
