...
describe('Service Tests', () => {
  describe('Pregunta Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Pregunta', async () => {
      ...
      it('should update a Pregunta', async () => {
        const returnedFromService = Object.assign(
          {
            encabezado: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should not update a Pregunta', async () => {
      ...
      it('should return a list of Pregunta', async () => {
        const returnedFromService = Object.assign(
          {
            encabezado: 'BBBBBB',
            descripcion: 'BBBBBB',
      ...
      it('should not return a list of Pregunta', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Pregunta', async () => {
